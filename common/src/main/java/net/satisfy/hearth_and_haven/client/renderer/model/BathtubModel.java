package net.satisfy.hearth_and_haven.client.renderer.model;
...
public class BathtubModel extends Model {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(HearthAndHaven.identifier("bathtub"), "main");
