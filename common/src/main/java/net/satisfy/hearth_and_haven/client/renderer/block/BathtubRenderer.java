package net.satisfy.hearth_and_haven.client.renderer.block;
...
import net.satisfy.hearth_and_haven.core.block.BathtubBlock;
...
public class BathtubRenderer implements BlockEntityRenderer<BathtubBlockEntity> {
    private static final ResourceLocation TEXTURE = HearthAndHaven.identifier("textures/entity/bathtub.png");
