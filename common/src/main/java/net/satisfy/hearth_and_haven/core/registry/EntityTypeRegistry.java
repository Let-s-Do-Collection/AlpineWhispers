...
import net.satisfy.hearth_and_haven.core.block.entity.*;
import net.satisfy.hearth_and_haven.core.entity.ChairEntity;
...
public class EntityTypeRegistry {
    private static final Registrar<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister.create(HearthAndHaven.MOD_ID, Registries.BLOCK_ENTITY_TYPE).getRegistrar();
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(HearthAndHaven.MOD_ID, Registries.ENTITY_TYPE);
    ...
    private static <T extends BlockEntityType<?>> RegistrySupplier<T> registerBlockEntity(final String path, final Supplier<T> type) {
        return BLOCK_ENTITY_TYPES.register(HearthAndHaven.identifier(path), type);
    }

    private static <T extends EntityType<?>> RegistrySupplier<T> registerEntityType(final Supplier<T> type) {
        return ENTITY_TYPES.register(HearthAndHaven.identifier("chair"), type);
    }
